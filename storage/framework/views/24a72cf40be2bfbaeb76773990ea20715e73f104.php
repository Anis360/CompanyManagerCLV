<?php $__env->startSection('content'); ?>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="table">
                            ...
                            <?php foreach($editeurs as $editeur): ?>
                                <tr>
                                    <td class="tdnom"><?php echo e($editeur->Nom_Ed); ?></td>
                                    <td class="tdemail"><?php echo e($editeur->Email_Ed); ?></td>
                                    <td class="tdtel"><?php echo e($editeur->Tel_Ed); ?></td>
                                    <?php if(Auth::user()->role != 'Agent'): ?>
    ...
    <script type="text/javascript">
        ...
        function getContent(){
            ...
            xhr.open('GET','<?php echo e(route('EditeurController.search')); ?>/?search=' + searchValue ,true);
