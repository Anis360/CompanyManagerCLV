                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped table-hover" id="table">
                        ...
                        <?php foreach($inscriptions as $inscription): ?>
                            <tr>
                                <td class="tdcode"><?php echo e($inscription->Code_Inscription); ?></td>
                                <td class="tdnomstgre"><?php echo e($inscription->Nom_Stgre); ?></td>
                                <td class="tdthmss"><?php echo e($inscription->Theme_Session); ?></td>
                                <td class="tdstt"><?php echo e($inscription->Statut); ?></td>
                                <?php if(Auth::user()->role != 'Agent'): ?>
                        ...
                        <div class="col-8">
                            <select id="nomstgre" name="nomstgre" class="form-control" required="required">
                                ...
                                <?php foreach($stagiaires as $stagiaire): ?>
                                    <option value="<?php echo e($stagiaire->Prenom_Nom_Stgre); ?>">
                                        <?php echo e($stagiaire->Prenom_Nom_Stgre); ?>
...
<script type="text/javascript">
    ...
    function getContent(){
        ...
        xhr.open('GET','<?php echo e(route('InscriptionController.search')); ?>/?search=' + searchValue ,true);
