                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="table">
                            ...
                            @foreach ($themes as $theme)
                                <tr>
                                    <td class="tdtheme">{{ $theme->Nom_Theme }}</td>
                                    <td class="tded">{{ $theme->Nom_Ed }}</td>
                                    <td class="tdcat">{{ $theme->Categorie }}</td>
                                    <td class="tdscat">{{ $theme->Sous_Categorie }}</td>
                                    <td class="tdcode">{{ $theme->Code }}</td>
                                    <td class="tdexam">{{ $theme->Examen }}</td>
                                    <td class="tdoff">{{ $theme->Officiel }}</td>
                                    @if(Auth::user()->role != 'Agent')
                            ...
                            <div class="col-8">
                                <select id="cat" name="cat" class="form-control" required="required">
                                    ...
                                    @foreach ($categories as $categorie)
                                        <option value="{{ $categorie->Nom_Cat }}">
                                            {{ $categorie->Nom_Cat }}
                                        </option>
                                    @endforeach
                                </select>
...
*
    ...
    <script type="text/javascript">
        ...
        function getContent(){
            ...
            xhr.open('GET','{{route('ThemeController.search')}}/?search=' + searchValue ,true);
