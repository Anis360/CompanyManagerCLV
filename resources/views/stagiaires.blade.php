...
@section('content')
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="table">
                            ...
                            @foreach ($stagiaires as $stagiaire)
                                <tr>
                                    <td class="tdnom">{{ $stagiaire->Prenom_Nom_Stgre }}</td>
                                    <td class="tdste">{{ $stagiaire->Societe_Stgre }}</td>
                                    <td class="tdfn">{{ $stagiaire->Fonction_Stgre }}</td>
                                    <td class="tdtel">{{ $stagiaire->Tel_Stgre }}</td>
                                    <td class="tdemail">{{ $stagiaire->Email_Stgre }}</td>
                                    @if(Auth::user()->role != 'Agent')
    ...
    <script type="text/javascript">
        ...
        function getContent(){
            ...
            xhr.open('GET','{{route('StagiaireController.search')}}/?search=' + searchValue ,true);
