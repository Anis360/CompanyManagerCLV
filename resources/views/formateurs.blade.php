...
@section('content')
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="table">
                            ...
                            @foreach ($formateurs as $formateur)
                                <tr>
                                    <td class="tdnom">{{ $formateur->Prenom_Nom_Formateur }}</td>
                                    <td class="tdspec">{{ $formateur->Specialite_Formateur }}</td>
                                    <td class="tdtel">{{ $formateur->Tel_Formateur }}</td>
                                    @if(Auth::user()->role != 'Agent')
    ...
    <script type="text/javascript">
        ...
        function getContent(){
            ...
            xhr.open('GET','{{route('FormateurController.search')}}/?search=' + searchValue ,true);
